...
if promedio >= 4.0 and promedio <= 5.0:
    pension *= 0.3
    print(f'Al estudiante {nombre}, se le descuenta un 30% a la pension, por lo cual este seria el pago final {"%.0f" % pension}')
elif promedio < 4.0 and promedio > 0.0:
    iva = pension * 0.1
    pension += iva
    print(f'Al estudiante {nombre}, debera pagar la pension completa con el iva {"%.0f" %pension} ')