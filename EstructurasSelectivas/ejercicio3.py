...
if montoTotal > 500000: ##Se hace un condicional para saber si el monto total es mayor a 500000
    ...
    print(f'Valor invertido {inversion}, el valor prestado al banco es de: {prestamos} y el valor del credito del fabricante es {restanteCredito}') ##Imprimo los diferentes valores
    ...
    print(f'Valor invertido: {inversion}, valor de credito al fabricante {credito} (A el credito se le cobran estos intereses {intereses})') ## Imprimo los diferentes valores
else:
