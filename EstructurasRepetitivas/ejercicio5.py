...
promedioNiño = 0       # Inicializa el promedio de peso de los niños
promedioJovenes = 0    # Inicializa el promedio de peso de los jóvenes
promedioAdultos = 0    # Inicializa el promedio de peso de los adultos
promedioAncianos = 0   # Inicializa el promedio de peso de los ancianos
...
for i in range(1, 51):  # Inicia un bucle que se repetirá 50 veces, representando a 50 personas
    ...
    else:  # Si la edad no encaja en ninguna de las categorías anteriores
        print('Digito mal puesto')  # Muestra un mensaje de error
