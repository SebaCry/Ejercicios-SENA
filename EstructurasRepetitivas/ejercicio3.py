...
for i in range(1, 20): ## Se crea un bucle que repita los procedimientos 20 veces (20 estudiantes)
...
print(f'La calificacion mas alta del promedio es {max} y la nota mas minima del promedio es {min}. El promdio total es {promedio}') ## Se imprime cual fue la nota maxima, minima, y el promedio de los estudiantes
